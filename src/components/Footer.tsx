      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-400 text-sm max-w-md">
              Your trusted partner in Dubai real estate. We help you discover prime properties 
              and provide unparalleled expertise for buying, selling, and investing.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              <li>Office 1965, Tamani Arts Offices</li>
              <li>Business Bay, Dubai, U.A.E</li>
              <li>+971 50 123 4567</li>
              <li>info@aresharealestate.com</li>
            </ul>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-gray-500 text-sm">
            © {new Date().getFullYear()} Aresha Real Estate. All rights reserved.
          </p>
          <div className="flex items-center gap-4">
            ...
            >
              <svg className="w-5 h-5 text-gray-400 group-hover:text-slate-900" viewBox="0 0 24 24" fill="currentColor">
            ...
            <a
              href="https://instagram.com/aresharealestate"
              target="_blank"
              rel="noopener noreferrer"
              className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-gold-500 transition-colors group"
            >
            ...
            <a
              href="https://facebook.com/aresharealestate"
              target="_blank"
              rel="noopener noreferrer"
              className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-gold-500 transition-colors group"
            >
